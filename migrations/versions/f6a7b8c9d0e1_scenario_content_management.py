...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("quiz", ormar.fields.sqlalchemy_uuid.CHAR(32), sa.ForeignKey("quiz.id", ondelete="CASCADE"), nullable=False),
        sa.Column("created_by", ormar.fields.sqlalchemy_uuid.CHAR(32), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False),
        sa.Column("version_number", sa.Integer(), nullable=False),
        sa.Column("status", sa.String(length=16), nullable=False, server_default="draft"),
        sa.Column("label", sa.String(length=160), nullable=False, server_default="Draft"),
        sa.Column("change_summary", sa.Text(), nullable=True),
        sa.Column("parent_version_id", ormar.fields.sqlalchemy_uuid.CHAR(32), nullable=True),
