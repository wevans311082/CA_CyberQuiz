<script lang="ts">
	...
	import ExerciseOperationsPanel from './ExerciseOperationsPanel.svelte';
...
<ExerciseOperationsPanel bind:open={operations_open} game_id={game_token} />
